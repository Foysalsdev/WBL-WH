...
export const MODULES: ModuleDef[] = [
  ...
  { key: 'masters',   label: 'Catalog & Parties',   shortLabel: 'Masters',  description: 'Products, dealers, sourcing, warehouses', icon: Database,      phase: 2, enabled: false },
  { key: 'inbound',   label: 'Inbound · GRN',       shortLabel: 'Inbound',  description: 'Purchase orders & goods receipt',     icon: PackageOpen,     phase: 3, enabled: false },
